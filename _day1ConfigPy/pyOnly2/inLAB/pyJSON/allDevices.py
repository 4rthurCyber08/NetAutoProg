...
#Check user needs to be prompt for info
if os.path.exists('userDeviceInfo.json') == False:
    ...
    macIsValid1 = bool(re.search(regexMAC, camera6MAC))
    
    while macIsValid1 == False:
    ...
    macIsValid2 = bool(re.search(regexMAC, camera8MAC))
    
    while macIsValid2 == False:
    ...
    with open('userDeviceInfo.json', 'w') as file:
        ...
        jsoncontent = json.dumps(jsonData, indent=2)
