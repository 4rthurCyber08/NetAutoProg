...
#specify ip address for each cameras
configCameras = [
...
input(r'Press Enter to close terminal. [A "_1-coreBABA-shrun.txt" will be created containing show run output for the device]')

#create a text file for show run command
with open(r'_1-coreBABA-shrun.txt', 'w') as file:
    file.write(showRun)
