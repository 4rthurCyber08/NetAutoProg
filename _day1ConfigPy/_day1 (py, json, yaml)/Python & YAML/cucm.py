...
peer_1 = yaml_configs['analog']['peer_1']
peer_2 = yaml_configs['analog']['peer_2']
peer_3 = yaml_configs['analog']['peer_3']
peer_4 = yaml_configs['analog']['peer_4']
tele = yaml_configs['telephony']
dn_1 = tele['dn_1']
dn_2 = tele['dn_2']
dn_3 = tele['dn_3']
dn_4 = tele['dn_4']
...
dn_7 = tele['dn_7']
dn_8 = tele['dn_8']
ivrs = yaml_configs['ivrs']
ospf = yaml_configs['ospf']
all_callers = yaml_configs['active_monitors']
