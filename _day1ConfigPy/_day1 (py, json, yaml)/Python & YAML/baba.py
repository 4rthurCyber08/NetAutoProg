...
svi = ips['svi']
cam = ips['cam_ip']
dhcp = yaml_configs['dhcp']
pool = dhcp['pool']
v_names = yaml_configs['switchport']['vlan_names']
access_port = yaml_configs['switchport']['access']
voice_port = yaml_configs['switchport']['voice']
...
#pprint.pp(switchport_commands, indent=4)