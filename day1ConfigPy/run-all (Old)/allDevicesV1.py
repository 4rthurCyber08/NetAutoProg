...
# -update host key based on user's monitorNumber
for primKey in deviceInfo:
    for innerKey in deviceInfo[primKey]:
        if innerKey == 'host':
            oldHostValue = deviceInfo[primKey][innerKey]
            newHostValue = re.sub(r'_', monitorNumber, oldHostValue)
            deviceInfo[primKey][innerKey] = newHostValue
...
#set default route
configDefaultRoute = [
    f'ip route 0.0.0.0 0.0.0.0 10.{monitorNumber}.{monitorNumber}.1 120'
]
...
configStaticRoute = [
    'ip routing'
    'ip route 10.11.0.0 255.255.0.0 200.0.0.11 120',
    'ip route 10.12.0.0 255.255.0.0 200.0.0.12 120',
    'ip route 10.21.0.0 255.255.0.0 200.0.0.21 120',
    'ip route 10.22.0.0 255.255.0.0 200.0.0.22 120',
    'ip route 10.31.0.0 255.255.0.0 200.0.0.31 120',
    'ip route 10.32.0.0 255.255.0.0 200.0.0.32 120',
    'ip route 10.41.0.0 255.255.0.0 200.0.0.41 120',
    'ip route 10.42.0.0 255.255.0.0 200.0.0.42 120',
    'ip route 10.51.0.0 255.255.0.0 200.0.0.51 120',
    'ip route 10.52.0.0 255.255.0.0 200.0.0.52 120',
    'ip route 10.61.0.0 255.255.0.0 200.0.0.61 120',
    'ip route 10.62.0.0 255.255.0.0 200.0.0.62 120',
    'ip route 10.71.0.0 255.255.0.0 200.0.0.71 120',
    'ip route 10.72.0.0 255.255.0.0 200.0.0.72 120',
    'ip route 10.81.0.0 255.255.0.0 200.0.0.81 120',
    'ip route 10.82.0.0 255.255.0.0 200.0.0.82 120',
    f'ip route 10.{monitorNumber}.0.0 255.255.0.0 10.{monitorNumber}.{monitorNumber}.4 120',
]
